    ...
    <div className="reviewSection">
      <Container>
        <Swiper
          ...
          modules={[Autoplay, Navigation, FreeMode, A11y]}
          className={"thoughtSlider3 mt-4"}
        >
              ...
              <div className="slider_reviewWrap">
                <div className="row" style={{alignItems: 'center'}}>
                  <div className="col-md-6">
                    <div className={`imgBox ${review.class}`}>
                      <Image
                        src="/home/review/rev-bg.png"
                        width={250}
                        height={250}
                        alt=""
                        className="bg-dotted top"
                      />
                      <div className="innerWrap" style={{ background: `url(/home/review/bg-circle-${review.class}.${review.class === 'yellow' ? 'png' : 'svg'}) no-repeat center`}}>
                        <Image
                          src={`/home/review/quote-up-${review.class}.${(review.class === 'yellow') ? 'png' : 'svg'}`}
                          width={115}
                          height={115}
                          className="reviewIcon leftTop"
                          alt=""
                        />
                        <Image
                        ...
                        />
                        <Image
                          src={`/home/review/quote-down-${review.class}.${(review.class === 'yellow') ? 'png' : 'svg'}`}
                          width={115}
                          height={115}
                          className="reviewIcon rightBottom"
                          alt=""
                        />
                      </div>
                      <Image
                        ...
                        height={250}
                        alt=""
                        className="bg-dotted bottom"
                      />
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="contentWtap">
                      <div className="reviewPar mb-4" dangerouslySetInnerHTML={{__html: review.review}} />
                      <h2 className={`${review.class}`}>{review.name}</h2>
                      <p className="subt">{review.position}</p>
                    </div>
                  </div>
                </div>
              </div>
